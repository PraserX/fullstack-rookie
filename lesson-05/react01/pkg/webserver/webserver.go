...
func serveStaticContent(router *gin.Engine, webRoot string) {
	router.Static("/fonts", webRoot+"/fonts")
	router.Static("/images", webRoot+"/images")
	router.StaticFile("/favicon.png", webRoot+"/favicon.png")
	router.StaticFile("/app.css", webRoot+"/app.css")
	router.StaticFile("/app.bundle.js", webRoot+"/app.bundle.js")
	router.StaticFile("/app.bundle.js.map", webRoot+"/app.bundle.js.map")
	router.StaticFile("/200.html", webRoot+"/200.html")
